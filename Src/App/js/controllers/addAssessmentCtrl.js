            ...
            function ($rootScope, $window, $scope, $location, $filter, storage, config, util, AssessmentService, LookupService) {
                ...
                function _getLookupValues() {
                    ...
                    LookupService.getAllCategories().then(function (result) {
                        ...
                        $scope.assessments.processRiskAssessments = [];
                        ...
                        _getAllProcessRisk(null, null);
                    }, util.handleHttpError);

                    _getAllKpiCategories(null, null);
                    _getAllCoreProcess(null, null);
                ...
                function _attachProcessRisksControlTypes() {
                    for (var key in $scope.assessments.processRiskAssessments) { // jshint ignore:line
                        ...
                        _.each(additionalAssessments.assessments, function (assessment, i) { /*jshint loopfunc: true */
