...
(function () {
    ...
    angular
        ...
        .factory('AssessmentService', ['common', function (common) {
            ...
            /**
             * Gets the risk rating report of an assessment.
             * @param {Object} assessment the assessment
             * @returns {promise} the promise with result
             */
            service.getRiskScore = function (assessment) {
                var req = {
                    method: 'POST',
                    url: '/api/v1/assessments/riskScore',
                    data: assessment
                };
                return common.makeRequest(req);
            };
            ...
            /**
             * Gets the risk rating report of an assessment by id.
             * @param {Object} assessmentId the assessment id
             * @returns {promise} the promise with result
             */
            service.getRiskScoreById = function (assessmentId) {
                var req = {
                    method: 'GET',
                    url: '/api/v1/assessments/' + assessmentId + '/riskScore'
                };
                return common.makeRequest(req);
            };
