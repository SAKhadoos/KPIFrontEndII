...
namespace JohnHancock.KPIScorecard.Tests
{
    ...
    internal static class TestHelper
    {
        ...
        /// </summary>
        internal const string TestResultsPath = @"..\..\..\JohnHancock.KPIScorecard.Tests\TestJsonResults\";
        ...
        {
            Execute(File.ReadAllText(@"..\..\..\..\Database\KST_TestData.sql"));
        }
        ...
        {
            Execute(File.ReadAllText(@"..\..\..\..\Database\KST_ClearTestData.sql"));
        }
        ...
        {
            AssertDatabaseRecordCount("KST_" + tableName, parameters, 1);
        }

        /// <summary>
        /// Asserts that record with given type and Id was deleted from the database.
        /// </summary>
        ///
        /// <typeparam name="T">The type of the entity.</typeparam>
        /// <param name="id">The entity Id.</param>
        internal static void AssertDatabaseEntityDeleted<T>(long id)
            where T : IdentifiableEntity
        {
            AssertDatabaseRecordCount("KST_" + typeof(T).Name, new Dictionary<string, object> { ["Id"] = id }, 0);
        }
