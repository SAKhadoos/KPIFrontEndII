...
namespace JohnHancock.ProjectCoeus.Services.Impl
{
    ...
    public class AssessmentServiceUnitTest : BaseServiceUnitTest<AssessmentService>
    {
        ...
        public void TestCreateAccuracy()
        {
            ...
            entity.Submitter = new User { Username = "CoeusOwnerUser1" };
            entity.BUFunctionalApprover = new User { Username = "CoeusBUFuncApp1" };
            entity.BURiskManagementApprover = new User { Username = "CoeusRiskManager" };
            entity.DivisionalRiskManagementApprover = new User { Username = "CoeusDivManager" };
            entity.Rejecter = new User { Username = "CoeusAdminUser" };
        ...
        public void TestSearchAccuracy3()
        {
            ...
            var criteria = new AssessmentSearchCriteria
            {
                BURiskManagementApproverUsername = "CoeusRiskManager",
                DivisionRiskManagementApproverUsername = "CoeusDivManager",
            };
        ...
        public void TestSearchAccuracy4()
        {
            ...
            var criteria = new AssessmentSearchCriteria
            {
                BUFunctionalApproverUsername = "CoeusBUFuncApp1",
                PageNumber = 2,
                PageSize = 2,
        ...
        public void TestSearchAccuracy6()
        {
            ...
            var criteria = new AssessmentSearchCriteria
            {
                RejecterUsername = "CoeusDivManager"
            };
        ...
        /// <summary>
        /// Tests the GetRiskScore method
        /// </summary>
        [TestMethod]
        public void TestGetRiskScore()
        {
            var entity = instance.Get(1);

            var result = instance.GetRiskScore(entity);
