...
{
    /// <summary>
    /// This controller exposes actions to manage operational incidents.
    /// </summary>
    /// 
    /// <threadsafety>
    ...
    [RoutePrefix("api/v1")]
    public class OperationalIncidentController : BaseController
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="OperationalIncidentController"/> class.
        /// </summary>
        public OperationalIncidentController()
        {
        }
        ...
        /// <remarks>Exceptions from services will be propagated.</remarks>
        [HttpGet]
        [Route("operationalIncidentsLastTalliedNumber")]
