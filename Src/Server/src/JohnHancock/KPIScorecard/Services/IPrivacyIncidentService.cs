...
{
    /// <summary>
    /// This interface defines operations for managing privacy incidents.
    /// </summary>
    ///
    /// <threadsafety>
    ...
    public interface IPrivacyIncidentService :
        IGenericService<PrivacyIncident, PrivacyIncidentSearchCriteria>
    {
        /// <summary>
