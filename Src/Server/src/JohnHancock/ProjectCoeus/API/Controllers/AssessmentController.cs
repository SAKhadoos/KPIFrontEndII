...
namespace JohnHancock.ProjectCoeus.API.Controllers
{
    ...
    /// <para>
    /// Changes in 1.3 during JOHN HANCOCK - PROJECT COEUS ADMIN BACKEND ASSEMBLY:
    ...
    public class AssessmentController : BaseController
    {
        ...
        public override void CheckConfiguration()
        {
            ...
            CommonHelper.ValidateConfigPropertyNotNull(AssessmentService, nameof(AssessmentService));
            CommonHelper.ValidateConfigPropertyNotNull(UserService, nameof(UserService));
            CommonHelper.ValidateConfigPropertyNotNull(AuditService, nameof(AuditService));
        ...
        /// <summary>
        /// This method is used to calculate risk score of an assessment.
        /// </summary>
        ///
        ...
        /// <remarks>All exceptions from services will be propagated.</remarks>
        [HttpGet]
        [Route("assessments/{id}/riskScore")]
        ...
        /// <summary>
        /// This method is used to calculate risk score of a given assessment.
        /// </summary>
        ///
        /// <param name="assessment">The assessment.</param>
        /// <returns>The risk score.</returns>
        ...
        /// <remarks>All exceptions from services will be propagated.</remarks>
        [HttpPost]
        [Route("assessments/riskScore")]
        public RiskScore GetRiskScore(Assessment assessment)
        {
            return AssessmentService.GetRiskScore(assessment);
        }
        ...
        /// <summary>
        /// Checks whether current user is allowed to approve the assessment.
        /// </summary>
        /// <param name="entity">The assessment.</param>
        ...
        /// If current user is not allowed to reject the assessment.
        /// </exception>
        private void CheckCanApprove(Assessment entity, Role validRole)
        {
        ...
        {
            CommonHelper.ValidateArgumentNotNull(entity.FunctionalArea, nameof(entity.FunctionalArea));
